...
module ActionView::Helpers::AssetTagHelper
  ...
  #
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#257
  ...
  #
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#298
  ...
  #
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#416
  ...
  #
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#341
  ...
  #
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#192
  ...
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#559
  def check_for_image_tag_errors(options); end

  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#550
  def extract_dimensions(size); end

  # @yield [options]
  #
  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#523
  def multiple_sources_tag_builder(type, sources); end

  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#540
  def resolve_asset_source(asset_type, source, skip_pipeline); end

  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#565
  def resolve_link_as(extname, mime_type); end

  # source://actionview//lib/action_view/helpers/asset_tag_helper.rb#576
...
#
# source://actionview//lib/action_view/helpers/asset_tag_helper.rb#575
...
module ActionView::Helpers::SanitizeHelper
  ...
  #
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#82
  def sanitize(html, options = T.unsafe(nil)); end

  # Sanitizes a block of CSS code. Used by +sanitize+ when it comes across a style attribute.
  #
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#87
  ...
  #   # => &lt;malformed &amp; link
  #
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#121
  ...
  #
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#104
...
module ActionView::Helpers::SanitizeHelper::ClassMethods
  ...
  #
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#126
  ...
  #   end
  #
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#166
  ...
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#136
  ...
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#132
  ...
  # source://actionview//lib/action_view/helpers/sanitize_helper.rb#128
...
class ActionView::Helpers::Tags::Base
  ...
  # source://actionview//lib/action_view/helpers/tags/base.rb#151
  def add_options(option_tags, options, value = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://actionview//lib/action_view/helpers/tags/base.rb#177
  def generate_ids?; end

  # source://actionview//lib/action_view/helpers/tags/base.rb#169
  def name_and_id_index(options); end

  # @return [Boolean]
  #
  # source://actionview//lib/action_view/helpers/tags/base.rb#146
...
module ActionView::Helpers::TextHelper
  ...
  #   <% end %>
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#394
  ...
  #  <% end %>
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#370
  ...
  #   </table>
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#417
  ...
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#318
  ...
  # source://actionview//lib/action_view/helpers/text_helper.rb#480
  ...
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#462
  def get_cycle(name); end

  # source://actionview//lib/action_view/helpers/text_helper.rb#467
  def set_cycle(name, cycle_object); end

  # source://actionview//lib/action_view/helpers/text_helper.rb#472
...
class ActionView::Helpers::TextHelper::Cycle
  ...
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#425
  ...
  #
  # source://actionview//lib/action_view/helpers/text_helper.rb#423
  def values; end

  private

  # source://actionview//lib/action_view/helpers/text_helper.rb#445
  def next_index; end
...
class ActionView::LookupContext
  ...
  #
  # source://actionview//lib/action_view/lookup_context.rb#228
  def initialize(view_paths, details = T.unsafe(nil), prefixes = T.unsafe(nil)); end

  # source://actionview//lib/action_view/lookup_context.rb#238
  def digest_cache; end

  # Override formats= to expand ["*/*"] values and automatically
  # add :html as fallback to :js.
  #
  # source://actionview//lib/action_view/lookup_context.rb#259
  def formats=(values); end

  # Override locale to return a symbol instead of array.
  #
  # source://actionview//lib/action_view/lookup_context.rb#279
  def locale; end
...
module ActionView::LookupContext::ViewPaths
  ...
  # source://actionview//lib/action_view/lookup_context.rb#151
  ...
  #
  # source://actionview//lib/action_view/lookup_context.rb#162
  def build_view_paths(paths); end

  # Compute details hash and key according to user options (e.g. passed from #render).
  #
  # source://actionview//lib/action_view/lookup_context.rb#171
  def detail_args_for(options); end

  # source://actionview//lib/action_view/lookup_context.rb#184
  def detail_args_for_any; end

  # Fix when prefix is specified as part of the template name
  #
  # source://actionview//lib/action_view/lookup_context.rb#205
...
module ActionView::RoutingUrlFor
  ...
  # source://actionpack/7.1.0.alpha-2fa766d9bc9da5087b76b153423ac99d3156aaa9/lib/action_dispatch/routing/url_for.rb#99
...
class ActionView::Template
  ...
  #
  # source://actionview//lib/action_view/template.rb#122
  def handler; end
  ...
  #
  # source://actionview//lib/action_view/template.rb#150
  def locals; end
  ...
  # source://actionview//lib/action_view/template.rb#306
  def method_name; end
  ...
  # @return [Boolean]
  #
  # source://actionview//lib/action_view/template.rb#178
  ...
  # source://actionview//lib/action_view/template.rb#202
  def type; end
  ...
  #
  # source://actionview//lib/action_view/template.rb#353
  def compiled_source; end

  # source://actionview//lib/action_view/template.rb#315
  def find_node_by_id(node, node_id); end

  # source://actionview//lib/action_view/template.rb#445
  def handle_render_error(view, e); end

  # source://actionview//lib/action_view/template.rb#467
  def identifier_method_name; end

  # source://actionview//lib/action_view/template.rb#471
  def instrument(action, &block); end

  # source://actionview//lib/action_view/template.rb#479
  def instrument_payload; end

  # source://actionview//lib/action_view/template.rb#475
  def instrument_render_template(&block); end

  # source://actionview//lib/action_view/template.rb#454
  def locals_code; end

  # source://actionview//lib/action_view/template.rb#437
  def offset; end

  class << self
    # source://actionview//lib/action_view/template.rb#119
...
class ActionView::Template::Handlers::ERB
  # source://actionview//lib/action_view/template/handlers/erb.rb#57
  def call(template, source); end
  ...
  # source location inside the template.
  #
  # source://actionview//lib/action_view/template/handlers/erb.rb#41
  def translate_location(spot, backtrace_location, source); end

  private

  # source://actionview//lib/action_view/template/handlers/erb.rb#104
  def find_offset(compiled, source_tokens, error_column); end

  # @raise [WrongEncodingError]
  #
  # source://actionview//lib/action_view/template/handlers/erb.rb#89
...
# source://actionview//lib/action_view/template.rb#125
...
module ActionView::TestCase::Behavior
  ...
  # @return [Boolean]
  #
  # source://actionview//lib/action_view/test_case.rb#283
