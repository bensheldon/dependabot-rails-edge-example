...
class ActionCable::Channel::Base
  ...
  # source://actioncable//lib/action_cable/channel/base.rb#279
  ...
  # @return [Boolean]
  #
  # source://actioncable//lib/action_cable/channel/base.rb#235
  def defer_subscription_confirmation?; end

  # source://actioncable//lib/action_cable/channel/base.rb#251
  def delegate_connection_identifiers; end

  # source://actioncable//lib/action_cable/channel/base.rb#267
  ...
  # source://actioncable//lib/action_cable/channel/base.rb#259
  def extract_action(data); end

  # source://actioncable//lib/action_cable/channel/base.rb#290
  def parameter_filter; end

  # @return [Boolean]
  #
  # source://actioncable//lib/action_cable/channel/base.rb#263
  def processable_action?(action); end

  # source://actioncable//lib/action_cable/channel/base.rb#243
  def reject; end

  # source://actioncable//lib/action_cable/channel/base.rb#305
  ...
  # @return [Boolean]
  #
  # source://actioncable//lib/action_cable/channel/base.rb#247
  ...
  # source://actioncable//lib/action_cable/channel/base.rb#294
  def transmit_subscription_confirmation; end

  # source://actioncable//lib/action_cable/channel/base.rb#310
...
class ActionCable::Channel::ConnectionStub
  ...
  # source://actioncable//lib/action_cable/channel/test_case.rb#69
  ...
  # source://actioncable//lib/action_cable/channel/test_case.rb#65
  def transmit(cable_message); end

  private

  # source://actioncable//lib/action_cable/channel/test_case.rb#74
...
class ActionCable::Channel::TestCase < ::ActiveSupport::TestCase
  ...
  # source://actioncable//lib/action_cable/channel/test_case.rb#194
...
# source://actioncable//lib/action_cable/channel/test_case.rb#185
module ActionCable::Channel::TestCase::Behavior
  ...
  # source://actioncable//lib/action_cable/channel/test_case.rb#276
  ...
  #   end
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#298
  ...
  #   end
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#309
  ...
  #   end
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#287
  ...
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#259
  ...
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#237
  def stub_connection(identifiers = T.unsafe(nil)); end

  # Subscribe to the channel under test. Optionally pass subscription parameters as a Hash.
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#242
  def subscribe(params = T.unsafe(nil)); end

  # Returns messages transmitted into channel
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#265
  def transmissions; end

  # Unsubscribe the subscription under test.
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#251
  def unsubscribe; end

  private

  # source://actioncable//lib/action_cable/channel/test_case.rb#318
  def broadcasting_for(stream_or_object); end

  # source://actioncable//lib/action_cable/channel/test_case.rb#314
...
# source://actioncable//lib/action_cable/channel/test_case.rb#201
module ActionCable::Channel::TestCase::Behavior::ClassMethods
  # source://actioncable//lib/action_cable/channel/test_case.rb#213
  def channel_class; end

  # @raise [NonInferrableChannelError]
  #
  # source://actioncable//lib/action_cable/channel/test_case.rb#221
...
class ActionCable::Server::Base
  ...
  #
  # source://actioncable//lib/action_cable/server/base.rb#89
  def connection_identifiers; end

  # Disconnect all the connections identified by +identifiers+ on this server or any others via RemoteConnections.
  #
  # source://actioncable//lib/action_cable/server/base.rb#39
  def disconnect(identifiers); end

  # source://actioncable//lib/action_cable/server/base.rb#64
  def event_loop; end
  ...
  #
  # source://actioncable//lib/action_cable/server/base.rb#84
  def pubsub; end

  # Gateway to RemoteConnections. See that class for details.
  #
  # source://actioncable//lib/action_cable/server/base.rb#60
  def remote_connections; end

  # source://actioncable//lib/action_cable/server/base.rb#43
  def restart; end
  ...
  #
  # source://actioncable//lib/action_cable/server/base.rb#79
  def worker_pool; end
...
class ActionCable::Server::Configuration
  ...
  #
  # source://actioncable//lib/action_cable/server/configuration.rb#30
...
class ActionCable::Server::Worker
  ...
  # source://activesupport/7.1.0.alpha-5940955ead7d1876d930f2d1008ff5887bfc6490/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#74
  def connection; end

  # source://activesupport/7.1.0.alpha-5940955ead7d1876d930f2d1008ff5887bfc6490/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#116
...
module ActionCable::TestHelper
  ...
  #   end
  #
  # source://actioncable//lib/action_cable/test_helper.rb#106
  ...
  #
  # source://actioncable//lib/action_cable/test_helper.rb#87
  def assert_no_broadcasts(stream, &block); end

  # source://actioncable//lib/action_cable/test_helper.rb#6
  def before_setup; end

  # source://actioncable//lib/action_cable/test_helper.rb#137
  def broadcasts(*_arg0, **_arg1, &_arg2); end

  # source://actioncable//lib/action_cable/test_helper.rb#137
  def clear_messages(*_arg0, **_arg1, &_arg2); end

  # source://actioncable//lib/action_cable/test_helper.rb#133
  def pubsub_adapter; end

  private

  # source://actioncable//lib/action_cable/test_helper.rb#140
